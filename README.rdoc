...
for generating ascii tables and trees. Using Hirb::Helpers::AutoTable, hirb has useful default views for popular database classes
...
* To create views, see Hirb::Formatter or {here if on the web}[http://tagaholic.me/hirb/doc/classes/Hirb/Formatter.html].
* To configure views, see Hirb::View or {here if on the web}[http://tagaholic.me/hirb/doc/classes/Hirb/View.html].
